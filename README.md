...
* Simulated data of Peachtree lottery sales in Georgia 2010-2025 (`georgia_lottery.RDS`)
...
*  Components of a model packaged as a web API with [Plumber](https://www.rplumber.io/index.html). (`plumber.R`, `lottery_model.rds`, and `deploy.R`)
